...
mod tests {
    ...
    fn encodes_one_tone_per_control_step_and_scanned_pixel() {
        assert_one_tone_per_control_step_and_scanned_pixel(SCOTTIE_DX);
    }

    #[test]
    fn transmission_lasts_header_plus_every_pass() {
        assert_transmission_lasts_header_plus_every_pass(SCOTTIE_DX);
    }
    ...
    fn sync_pulse_sits_between_the_blue_and_red_scans() {
        ...
        assert_eq!(SCOTTIE_DX.sync_pulse().0, green_and_blue_scans);
    }
}
